	...
	public function admin_init($page = 'chats'){
        ...
        foreach ($uniq_users as $uniq_user) {
            if ($uniq_user != "Admin" ) {
                ...
                $init_users .= '
                    <div class="hover-actions-trigger chat-contact nav-item pull_user_chats" role="tab" data-bs-toggle="tab" data-bs-target="#'.$user_ids.'" aria-controls="'.$user_ids.'" aria-selected="false">
                        <div class="d-flex p-3">
                            <div class="avatar avatar-xl">
                                <img class="rounded-circle" src="'.base_url('uploads/profiles/'.$user_info->Avatar).'" alt="" />
                            </div>
                ...
                $convos = $this->mod_chats->client_convos($uniq_user);
                $chats.= '
                ...
                foreach ($convos as $messages) {
                    ...
                    if ($messages['Chat_Sender'] == $uniq_user ) {
                        $chats.= '
                                <div class="d-flex p-3">
                                    <div class="avatar avatar-l me-2">
                                        <img class="rounded-circle" src="'.base_url('assets/img/team/11.jpg').'" alt="Admin" />

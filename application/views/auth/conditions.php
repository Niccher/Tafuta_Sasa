                        ...
                        <div class="col-lg-8 pe-lg-2">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <ol type="1">
                                        ...
                                        <li>You won’t violate our <a href="privacy-policy.html#!">Acceptable use policy</a>, which is part of this Agreement;</li>
                                    ...
                                    <p class="mb-0 ps-3"> If you think anyone is violating any of these Terms, please <a href="mailto:info@themewagon.com">notify us</a> immediately. If you received spam you think came from a Tafuta Sasa user, we want to <a href="mailto:info@themewagon.com">hear about it</a>. If you think anyone has posted material that violates any copyrights, then you may<a href="mailto:info@themewagon.com"> notify us</a>.</p>
                                    <hr class="my-4" />
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 ps-3"> To the extent that you are a business and we process personal data on your behalf in providing the Services, the <a href="privacy-policy.html#!">Data processing terms</a> shall apply and are incorporated into these Terms.</p>
                                </div>
                            </div>
                            <div class="card mb-3">
                                <div class="card-header bg-light">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Providing the Customer with bulk email sending via the Tafuta Sasa platform.</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>Sending campaigns through the Tafuta Sasa platform storing email addresses provided through one of our forms or integrations. Storing data on recipient behavior, whether they click, open, unsubscribe, bounce when a campaign is sent. Actioning on the Customer’s behalf any ‘unsubscribe’ requests from recipients of messages sent using the Service.</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="card sticky-top">
                                    ...
                                    <div class="card-body">
                                        <div class="terms-sidebar nav flex-column fs--1" id="terms-sidebar">
                                            <div class="nav-item"><a class="nav-link px-0 py-1" href="<?php echo base_url('auth/terms');?>#termination">Termination</a></div>
                                            <div class="nav-item"><a class="nav-link px-0 py-1" href="<?php echo base_url('auth/terms');?>#rules">Rules and abuse</a></div>
                                            <div class="nav-item"><a class="nav-link px-0 py-1" href="<?php echo base_url('auth/terms');?>#liability">Liability</a></div>
                                            <div class="nav-item"><a class="nav-link px-0 py-1" href="<?php echo base_url('auth/terms');?>#rights">Rights</a></div>
                                            <div class="nav-item"><a class="nav-link px-0 py-1" href="<?php echo base_url('auth/terms');?>#instructions">Instructions</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

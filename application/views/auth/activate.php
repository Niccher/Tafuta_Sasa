                                    ...
                                    <div class="col-md-7 d-flex flex-center">
                                        <div class="p-4 p-md-5 flex-grow-1">
                                            <div class="text-center">
                                                ...
                                                <p>An email has been sent to <strong>xyz@abc.com</strong>. Please click on the <br class="d-none d-sm-block d-md-none" />included link to reset your password.</p>
                                                <a class="btn btn-primary btn-sm mt-3" href="<?php echo base_url('auth/login');?>"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

    ...
    <div class="container" style="margin-bottom: 60px;">
		...
		<div class="card">
            ...
            <div class="row mt-12">
                    ...
                    <div class="card theme-wizard mb-5">
                        <div class="card-header bg-light pt-3 pb-2">
                            <ul class="nav justify-content-between nav-wizard">
                                <li class="nav-item">
                                    <a class="nav-link active fw-semi-bold" href="<?php echo base_url('search/question/search'); ?>#wiz_get_eml" data-bs-toggle="tab" data-wizard-step="data-wizard-step">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fw-semi-bold" href="<?php echo base_url('search/question/search'); ?>#wiz_get_finalize" data-bs-toggle="tab" data-wizard-step="data-wizard-step">
                                        <span class="nav-item-circle-parent">
                                            <span class="nav-item-circle">
                        ...
                        <div class="card-body py-4">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="wiz_get_finalize" id="wiz_get_finalize">
                                    <form class="row needs-validation" novalidate="">
                                        <div class="row">
                                                    ...
                                                    <div class="card-body bg-light">
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                            <div class="col-6">
                                                                ...
                                                                <input class="form-control" id="cardNumber" name="cardNumber" placeholder="XXXX XXXX XXXX XXXX" type="number" pattern="^([0-9]){20,20})" required="required" >
                                                                <div class="invalid-feedback">Card Number is needed</div>
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="cardName">Name of Card</label>
                                                                <input class="form-control" id="cardName" name="cardName" placeholder="John Doe" type="text" pattern="^([a-zA-Z0-9 ]){5,20})" required="required" >
                                                                <div class="invalid-feedback">Name on Card is needed</div>
                                                            </div>
                                                        </div>
                                                        <div class="row gx-3">
                                                            ...
                                                            <div class="col-6 col-sm-3">
                                                                <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="cardexpDate">Exp Date</label>
                                                                <input class="form-control" id="cardexpDate" placeholder="15/2024" type="text">
                                                            </div>
                                                            <div class="col-6 col-sm-3">
                                                                <label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0 fs--1" for="cardcvv">
                                                                    CVV
                                                                ...
                                                                <input class="form-control" id="cardcvv" placeholder="123" maxlength="3" pattern="[0-9]{3}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card h-100">
                                                    ...
                                                    <div class="card-body bg-light">
                                                        <div class="d-flex justify-content-between fs--1 mb-1">
                                                            ...
                                                            <span><?php echo ($list_answers_details->Qn_Price); ?>.00</span>
                                                        </div>
                                                        ...
                                                        <h5 class="d-flex justify-content-between">
                                                            <span>Amount</span><span>KES <?php echo ($list_answers_details->Qn_Price); ?>.00</span>
                                                        </h5>
                                                        <p class="fs--1 text-600">Once purchased, the answer will be available to use at any given time.</p>
                                                        <button class="btn btn-primary d-block w-100" type="submit">
                                                            <span class="fas fa-cart-arrow-down me-2"></span>Pay <?php echo ($list_answers_details->Qn_Price); ?>.00
                                                        </button>
                                                        <div class="text-center mt-2">
                ...
                <div class="row">
                    <div class="bg-light text-dark p-2 border-dashed mb-3 w-15"></div>
                    <div class="bg-light text-dark p-2 border-dashed mb-3 w-70">
                        <div class="col-md-12 col-xl-12 col-xxl-12 px-md-3 mb-xxl-0 position-relative">
                            <div class="d-flex">
                                <img class="me-3" src="<?php echo base_url('assets/img/icons/shield.png'); ?>" alt="" width="60" height="60">
                                <div class="flex-1">
                                    ...
                                    <div class="form-check mb-0">
                                        ...
                                        <label class="form-check-label mb-0" for="protection-option-1"> 
                                            <strong>Full Refund </strong>If you don't <br class="d-none d-md-block d-lg-none">receive your order
                                        </label>
                                    </div>
                                    <div class="form-check">

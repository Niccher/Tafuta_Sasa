    ...
    <div class="col-xxl-6 col-lg-12">
        <div class="card h-100">
            ...
            <div class="card-header z-index-1">
                <h5 class="text-primary">Welcome to Tafuta Sasa! </h5>
                ...
                <div class="row g-2 h-100 align-items-end">
                    <div class="col-sm-6 col-md-5">
                        <div class="d-flex position-relative">
                            ...
                            <div class="flex-1">
                                <a class="stretched-link" href="project-management.html#!">
    ...
    <div class="col-xxl-3 col-md-6">
        <div class="card h-100">
            <div class="card-header d-flex flex-between-center">
                ...
                <a class="btn btn-link btn-sm px-0" href="project-management.html#!">Report<span class="fas fa-chevron-right ms-1 fs--2"> </span></a>
            </div>
            <div class="card-body">
            ...
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col">
                        ...
                        <h5 class="text-primary fs-0">Tafuta Sasa discussion</h5>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body d-flex align-items-end">
                <div class="row g-3 justify-content-between">
                    <div class="col-10 mt-0">
                        <p class="fs--1 text-600 mb-0">The very first general meeting for planning Tafuta Sasa’s design and development roadmap</p>
                    </div>
...
<div class="row g-3 mb-3">
        ...
        <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="card overflow-hidden" style="min-width: 12rem">
                            ...
                            <div class="card-body position-relative">
                                ...
                                <a class="fw-semi-bold fs--1 text-nowrap" href="../app/e-commerce/customers.html">See all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="project-management.html#!">See all projects<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100">
            <div class="card-header bg-light d-flex flex-between-center">
                ...
                <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="documentations" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>
                    <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="documentations">
                        <a class="dropdown-item" href="project-management.html#!">Edit</a><a class="dropdown-item" href="project-management.html#!">Move</a><a class="dropdown-item" href="project-management.html#!">Resize</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-warning" href="project-management.html#!">Archive</a><a class="dropdown-item text-danger" href="project-management.html#!">Delete</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-footer bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-auto"><a class="btn btn-Tafuta Sasa-default btn-sm" href="project-management.html#!"><span class="d-none d-sm-inline-block me-1">Location</span>overview<span class="fa fa-chevron-right ms-1 fs--1"></span></a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100">
            <div class="card-header d-flex flex-between-center">
                ...
                <div class="dropdown font-sans-serif btn-reveal-trigger">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-project-statistics">
                        <a class="dropdown-item" href="project-management.html#!">View</a><a class="dropdown-item" href="project-management.html#!">Export</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-danger" href="project-management.html#!">Remove</a>
                    </div>
                </div>
            </div>
            <div class="card-body pt-0">
                ...
                <div class="d-flex flex-between-center rounded-3 bg-light p-3 mb-2">
                    ...
                    <a class="fs--2 text-600 mb-0" href="project-management.html#!">ThemeWagon</a>
                </div>
                <div class="d-flex flex-between-center rounded-3 bg-light p-3 mb-2">
                    <a href="project-management.html#!">
                        <h6 class="mb-0"><span class="fas fa-circle fs--1 me-3 text-warning"></span>Create Mobile View</h6>
                    </a>
                    <a class="fs--2 text-600 mb-0" href="project-management.html#!">Mailbluster</a>
                </div>
                <div class="d-flex flex-between-center rounded-3 bg-light p-3 mb-2">
                    <a href="project-management.html#!">
                        <h6 class="mb-0"><span class="fas fa-circle fs--1 me-3 text-secondary"></span>Create Landing Pages</h6>
                    </a>
                    <a class="fs--2 text-600 mb-0" href="project-management.html#!">BlackBOx</a>
                </div>
                <div class="d-flex flex-between-center rounded-3 bg-light p-3">
                    ...
                    <a class="fs--2 text-600 mb-0" href="project-management.html#!">Tafuta Sasa Team</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body scrollbar recent-activity-body-height ps-2">
                ...
                <div class="row g-3 timeline timeline-primary timeline-current pb-card">
                    ...
                    <div class="col">
                        <div class="row gx-0 border-bottom pb-card">
                            <div class="col">
                                <h6 class="text-800 mb-1">Tafuta Sasa v3.0.0 released with new features</h6>
                                <p class="fs--1 text-600 mb-0">Tafuta Sasa new version is released successfully with new Dashboards</p>
                            </div>
                            <div class="col-auto">
        ...
        <div class="card h-100 members-activity">
            <div class="card-header bg-light py-2 d-flex flex-between-center">
                ...
                <div class="dropdown font-sans-serif btn-reveal-trigger">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-members-activity">
                        <a class="dropdown-item" href="project-management.html#!">View</a><a class="dropdown-item" href="project-management.html#!">Export</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item text-danger" href="project-management.html#!">Remove</a>
                    </div>
            ...
            <div class="card-body scrollbar-overlay">
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative">
                        <img class="w-100" src="../assets/img/management/activity-7.png" alt="..." />
                        <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-soft-danger">20%</div>
                    </div>
                    <div class="col-4 position-relative">
                        <img class="w-100" src="../assets/img/management/activity-8.png" alt="..." />
                        <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-soft-success">67%</div>
                    </div>
                    <div class="col-4 position-relative">
                        <img class="w-100" src="../assets/img/management/activity-9.png" alt="..." />
                        <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-soft-primary">89%</div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block py-2" href="project-management.html#!">See all projects<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
        </div>
    </div>
        ...
        <div class="card h-100">
                        ...
                        <tbody>
                            <tr class="border-bottom border-200">
                                ...
                                <td class="align-middle text-center">
                                    <small class="badge fw-semi-bold rounded-pill badge-soft-danger">12%</small>
                                    <p class="fs--2 mb-0">1h:52m </p>
                                </td>
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-primary">68%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                            ...
                            <tr class="border-bottom border-200">
                                ...
                                <td class="align-middle text-center">
                                    <small class="badge fw-semi-bold rounded-pill badge-soft-success">86%</small>
                                    <p class="fs--2 mb-0">1h:52m </p>
                                </td>
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-warning">45%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                                        <div class="col-auto mt-auto">
                            ...
                            <tr class="border-bottom border-200">
                                ...
                                <td class="align-middle text-center"><small class="badge fw-semi-bold rounded-pill badge-soft-success">intime</small></td>
                                <td class="align-middle text-center">
                                    <small class="badge fw-semi-bold rounded-pill badge-soft-success">97%</small>
                                    <p class="fs--2 mb-0">1h:52m </p>
                                </td>
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-primary">60%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                                        <div class="col-auto mt-auto">
                            ...
                            <tr class="border-bottom border-200">
                                ...
                                <td class="align-middle text-center"><small class="badge fw-semi-bold rounded-pill badge-soft-success">intime</small></td>
                                <td class="align-middle text-center">
                                    <small class="badge fw-semi-bold rounded-pill badge-soft-warning">34%</small>
                                    <p class="fs--2 mb-0">1h:52m </p>
                                </td>
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-success">80%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                                        <div class="col-auto mt-auto">
                            ...
                            <tr class="border-bottom border-200">
                                ...
                                <td class="align-middle text-center"><small class="badge fw-semi-bold rounded-pill badge-soft-warning">Late</small></td>
                                <td class="align-middle text-center">
                                    <small class="badge fw-semi-bold rounded-pill badge-soft-primary">12%</small>
                                    <p class="fs--2 mb-0">1h:52m </p>
                                </td>
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-danger">68%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                                        <div class="col-auto mt-auto">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="row g-2 justify-content-end">
                                        <div class="col-auto">
                                            <small class="badge fw-semi-bold rounded-pill badge-soft-success">68%</small>
                                            <p class="fs--2 mb-0">1h:52m </p>
                                        </div>
                                        <div class="col-auto mt-auto">
            ...
            <div class="card-footer bg-light py-2">
                <div class="row flex-between-center">
                    ...
                    <div class="col-auto"><a class="btn btn-sm btn-link px-0 fw-medium" href="project-management.html#!">View All<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
                </div>
            </div>
        </div>
    </div>
    <div class="col-12 order-xxl-3">
        <div class="card" id="runningProjectTable" data-list='{"valueNames":["projects","worked","time","date"]}'>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <div class="flex-1 ms-3">
                                            ...
                                            <p class="text-500 fs--2 mb-0">Tafuta Sasa</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="align-middle text-center">
            ...
            <div class="card-footer bg-light py-0 text-center"><a class="btn btn-sm btn-link py-2" href="project-management.html#!">Show All Projects<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
        </div>
    </div>
</div>
<div class="row g-3">

...
<div class="row g-0">
    <div class="col-lg-8 pe-lg-2">
            ...
            <div class="card-body bg-light">
                <form>
                    <div class="row gx-2">
                        ...
                        <div class="col-sm-6">
                            <label class="form-label" for="time-zone">Timezone</label>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <form class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone" action="create-an-event.html#!">
                        ...
                        <div class="d-flex media align-items-center mb-3 pb-3 border-bottom btn-reveal-trigger">
                            ...
                            <div class="flex-1 d-flex flex-between-center">
                                ...
                                <div class="dropdown font-sans-serif">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-2"><a class="dropdown-item" href="create-an-event.html#!" data-dz-remove="data-dz-remove">Remove File</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-4 ps-lg-2">
        <div class="sticky-sidebar">
            <div class="card mb-lg-0">
                ...
                <div class="card-body bg-light">
                    <div class="mb-3">
                        <div class="d-flex flex-between-center"><label class="form-label" for="organizer">Organizer</label><button class="btn btn-link btn-sm pe-0" type="button">Add New</button></div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex flex-between-center"><label class="form-label" for="sponsors">Sponsors</label><button class="btn btn-link btn-sm pe-0" type="button">Add New</button></div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center"><label class="mb-0" for="event-tags">Tags</label><button class="btn btn-link btn-sm pe-0" type="button">Add New</button></div>
                    ...
                    <div class="mb-3 form-check">
                        <input class="form-check-input" id="customRadio4" type="radio" name="listingPrivacy" checked="checked" /><label class="form-label mb-0" for="customRadio4"> <strong>Public page:</strong></label>
                        <div class="form-text mt-0">Discoverable by anyone on Falcon, our distribution partners, and search engines.</div>
                    </div>
                    <div class="mb-3 form-check">
                        <input class="form-check-input" id="customRadio5" type="radio" name="listingPrivacy" /><label class="form-label mb-0" for="customRadio5"> <strong>Private page:</strong></label>

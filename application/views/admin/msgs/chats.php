                ...
                <div class="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">John Bradley</h6>
                                    <span class="message-time fs--2">Fri</span>
                                </div>
                                <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-7" data-bs-toggle="tab" data-bs-target="#chat-7" aria-controls="chat-7" aria-selected="false">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">Rory McCann</h6>
                                    <span class="message-time fs--2">Sun</span>
                                </div>
                                <div class="min-w-0">
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-8" data-bs-toggle="tab" data-bs-target="#chat-8" aria-controls="chat-8" aria-selected="false">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">Joe Bempsie</h6>
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-9" data-bs-toggle="tab" data-bs-target="#chat-9" aria-controls="chat-9" aria-selected="false">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">Diana Rigg</h6>
                                    <span class="message-time fs--2">Mon</span>
                                </div>
                                <div class="min-w-0">
                ...
                <div class="chat-content-header">
                    <div class="row flex-between-center">
                        <div class="col-6 col-sm-8 d-flex align-items-center">
                            <a class="pe-3 text-700 d-md-none contacts-list-show" href="chat.html#!">
                            ...
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    ...
                                    <div class="dropdown z-index-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-6">
                                            <a class="dropdown-item" href="chat.html#!">Mute</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="chat.html#!">Archive</a><a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="px-3 pt-2">
                                <div class="nav flex-column font-sans-serif fw-medium"><a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="chat.html#!"><span class="conversation-info-icon"><span class="fas fa-search me-1" data-fa-transform="shrink-1 down-3"></span></span>Search in Conversation</a><a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="chat.html#!"><span class="conversation-info-icon"><span class="fas fa-pencil-alt me-1" data-fa-transform="shrink-1"></span></span>Edit Nicknames</a><a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="chat.html#!"><span class="conversation-info-icon"><span class="fas fa-palette me-1" data-fa-transform="shrink-1"></span></span><span>Change Color</span></a><a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="chat.html#!"><span class="conversation-info-icon"><span class="fas fa-thumbs-up me-1" data-fa-transform="shrink-1"></span></span>Change Emoji</a><a class="nav-link d-flex align-items-center py-1 px-0 text-600" href="chat.html#!"><span class="conversation-info-icon"><span class="fas fa-bell me-1" data-fa-transform="shrink-1"></span></span>Notifications</a></div>
                            </div>
                            <hr class="my-2" />
                            <div class="px-3" id="others-info-6">
                                <div class="title" id="shared-media-title-6"><a class="btn btn-link btn-accordion hover-text-decoration-none dropdown-indicator" href="chat.html#shared-media-6" data-bs-toggle="collapse" aria-expanded="false" aria-controls="shared-media-6">Shared media</a></div>
                                ...
                                <div class="w-xxl-75">
                                    <div class="hover-actions-trigger d-flex align-items-center">
                                        ...
                                        <ul class="hover-actions position-relative list-inline mb-0 text-400 ms-2">
                                            <li class="list-inline-item"><a class="chat-option" href="chat.html#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Forward"><span class="fas fa-share"></span></a></li>
                                            <li class="list-inline-item"><a class="chat-option" href="chat.html#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></a></li>
                                            <li class="list-inline-item"><a class="chat-option" href="chat.html#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-edit"></span></a></li>
                                            <li class="list-inline-item"><a class="chat-option" href="chat.html#!" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove"><span class="fas fa-trash-alt"></span></a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="conversation-info" data-index="7">
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    ...
                                    <div class="dropdown z-index-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-7">
                                            <a class="dropdown-item" href="chat.html#!">Mute</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="chat.html#!">Archive</a><a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                            ...
                            <div class="px-3" id="others-info-7">
                                <div class="title" id="shared-media-title-7"><a class="btn btn-link btn-accordion hover-text-decoration-none dropdown-indicator" href="chat.html#shared-media-7" data-bs-toggle="collapse" aria-expanded="false" aria-controls="shared-media-7">Shared media</a></div>
                    ...
                    <div class="conversation-info" data-index="8">
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    ...
                                    <div class="dropdown z-index-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-8">
                                            <a class="dropdown-item" href="chat.html#!">Mute</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="chat.html#!">Archive</a><a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                            ...
                            <div class="px-3" id="others-info-8">
                                <div class="title" id="shared-media-title-8"><a class="btn btn-link btn-accordion hover-text-decoration-none dropdown-indicator" href="chat.html#shared-media-8" data-bs-toggle="collapse" aria-expanded="false" aria-controls="shared-media-8">Shared media</a></div>
                    ...
                    <div class="conversation-info" data-index="9">
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    ...
                                    <div class="dropdown z-index-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-9">
                                            <a class="dropdown-item" href="chat.html#!">Mute</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="chat.html#!">Archive</a><a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                            ...
                            <div class="px-3" id="others-info-9">
                                <div class="title" id="shared-media-title-9"><a class="btn btn-link btn-accordion hover-text-decoration-none dropdown-indicator" href="chat.html#shared-media-9" data-bs-toggle="collapse" aria-expanded="false" aria-controls="shared-media-9">Shared media</a></div>
                    ...
                    <div class="conversation-info" data-index="10">
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    ...
                                    <div class="dropdown z-index-1">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-10">
                                            <a class="dropdown-item" href="chat.html#!">Mute</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="chat.html#!">Archive</a><a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                            ...
                            <div class="px-3" id="others-info-10">
                                <div class="title" id="shared-media-title-10"><a class="btn btn-link btn-accordion hover-text-decoration-none dropdown-indicator" href="chat.html#shared-media-10" data-bs-toggle="collapse" aria-expanded="false" aria-controls="shared-media-10">Shared media</a></div>

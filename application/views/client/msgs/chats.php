                ...
                <div class="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">Admin</h6>
                    ...
                    <div class="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-7" data-bs-toggle="tab" data-bs-target="#chat-7" aria-controls="chat-7" aria-selected="false">
                        <div class="d-flex p-3">
                            ...
                            <div class="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-0 chat-contact-title">Account Support</h6>
                ...
                <div class="chat-content-header">
                    <div class="row flex-between-center">
                        <div class="col-6 col-sm-8 d-flex align-items-center">
                            ...
                            <div class="min-w-0">
                                <h5 class="mb-0 text-truncate fs-0">Administrator</h5>
                ...
                <div class="chat-content-body" style="display: inherit;">
                        ...
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    <h6 class="mb-0"><a class="text-decoration-none stretched-link text-700" href="#">Administrator</a></h6>
                                    <div class="dropdown z-index-1">
                                        <button class="btn btn-link btn-sm text-400 dropdown-toggle dropdown-caret-none me-n3" type="button" id="profile-dropdown-6" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="profile-dropdown-6">
                                            ...
                                            <a class="dropdown-item text-danger" href="chat.html#!">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="chat-content-scroll-area scrollbar">
                        <div class="d-flex position-relative p-3 border-bottom mb-3 align-items-center">
                            ...
                            <div class="flex-1">
                                <h6 class="mb-0"><a class="text-decoration-none stretched-link text-700" href="#">Administrator</a></h6>
                                <p class="mb-0">You friends with Administrator.</p>
                            </div>
                        </div>
                        <div class="text-center fs--2 text-500"><span>May 5, 2021, 11:54 am</span></div>
                        <div class="d-flex p-3">
                    ...
                    <div class="conversation-info" data-index="7">
                        <div class="h-100 overflow-auto scrollbar">
                            <div class="d-flex position-relative align-items-center p-3 border-bottom">
                                ...
                                <div class="flex-1 ms-2 d-flex flex-between-center">
                                    <h6 class="mb-0"><a class="text-decoration-none stretched-link text-700" href="#">Account Support</a></h6>
                                    <div class="dropdown z-index-1">

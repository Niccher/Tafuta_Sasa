                    ...
                    <div class="card h-lg-100 overflow-hidden">
                        ...
                        echo '
                            <div class="row g-0 align-items-center py-2 position-relative border-bottom border-200">
                                <div class="col-4 ps-card py-1 position-static">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h6 class="mb-0 d-flex">
                                                <a class="text-800 stretched-link" href="'.base_url("search/answer/id?q_name=".urlencode($this->mod_crypt->Dec_String($qu_info->Qn_Name))).'">'.character_limiter(strip_tags($this->mod_crypt->Dec_String($qu_info->Qn_Name)), 40).'</a>
                                            </h6>
                                            <span>
                                                <small>
                                                    <h8 class="mb-0 d-flex align-items-center"><i class="fas fa-clock"></i>'.date('M d H:i A',$qu_info->Qn_Created).'</h8>
                                                </small>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="row flex-end-center g-0">
                                        <div class="col-12 pe-2">
                                            ...
                                            '.word_limiter(strip_tags($this->mod_crypt->Dec_String($qu_info->Qn_Answer)), 20).'
                                            </div>
                                        </div>
                                    </div>
                                </div>

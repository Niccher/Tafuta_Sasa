                                ...
                                <div class="card-body">
                                    <div class="row h-100 justify-content-between g-0">
                                        ...
                                        <div class="col-auto position-relative">
                                            ...
                                            <div class="position-absolute top-50 start-50 translate-middle text-dark fs-2">26</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card h-lg-100 overflow-hidden">
                                <div class="card-header">
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h6 class="mb-0">Most Recent Questions</h6>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1">
                                                    <h6 class="mb-0 d-flex align-items-center">
                                                        <a class="text-800 stretched-link" href="<?php echo base_url('search/question/clean'); ?>">Question Name Here 01</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col py-1">
                                            <div class="row flex-end-center g-0">
                                                <div class="col-auto pe-2">
                                                    <div class="fs--1 fw-semi-bold">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod...</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer bg-light p-0">
                                    <a class="btn btn-sm btn-link d-block w-100 py-2" href="<?php echo base_url('search/question/clean'); ?>">Show all projects
